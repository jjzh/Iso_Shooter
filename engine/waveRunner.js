...
import { initTelegraph, createTelegraph, updateTelegraph, removeTelegraph } from './telegraph.js';
...
const waveState = {
  status: 'idle',          // 'idle' | 'announce' | 'running' | 'cleared' | 'victory'
  waveIndex: 0,
  elapsedMs: 0,            // ms since wave entered 'running'
  announceTimer: 0,
  clearPauseTimer: 0,
  groups: [],              // runtime state per group
};
